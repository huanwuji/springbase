 ...
 */
public abstract class AbstractTreeJpaRepository<T extends IdEntity, ID extends IdEntity> implements JpaRepository<T, ID> {

    @PersistenceContext
    private EntityManager em;

    private static final int TREE_ID_INC_STEP = 5;
