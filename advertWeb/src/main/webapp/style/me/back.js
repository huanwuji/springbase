(function () {
    angular.module('huanwuji', ['ui.router', 'angularTree', 'ui.bootstrap', 'ngResource', 'ngRoute'])
                ...
                function ($stateProvider, $routeProvider, $urlRouterProvider) {
                    ...
                    var stateConfig = {
                        tree: {
                            main: function (name, serviceName) {
                                return [name, {
                                    url: '/' + name,
                                    templateUrl: '/tmpl/back/' + name + '/main.html',
                            ...
                            list: function (name, serviceName) {
                                return [name + '.list', {
                                    parent: name,
                                    url: '',
                                    templateUrl: '/tmpl/back/' + name + '/list.html'
                                }]
                            },
                            detail: function (name, serviceName) {
                                return [name + '.detail', {
                                    parent: name,
                                    url: '/{id}/{parentId}',
                                    templateUrl: '/tmpl/back/' + name + '/detail.html',
                        ...
                        entry: {
                            detail: function (parent, name) {
                                return [parent + '.entry.detail', {
                                    parent: parent,
                                    url: '/entry/{key}/{fkId}',
                                    templateUrl: '/tmpl/back/entry/detail.html',
                    ...
                    $stateProvider
                        .state('systemCode.gift', {
                            parent: "systemCode",
                            url: '/gift/cid/{cid}',
                            templateUrl: '/tmpl/back/gift/list.html',
                        ...
                        .state('systemCode.gift.detail', {
                            parent: 'systemCode',
                            url: '/gift/cid/{cid}/{id}',
                            templateUrl: '/tmpl/back/gift/detail.html',
                            controller: ['$scope', '$state', '$stateParams', 'Service', 'hwjConfig',
                                function ($scope, $state, $stateParams, Service, hwjConfig) {
                                    var cid = $stateParams.cid;
                                    var id = $stateParams.id;
